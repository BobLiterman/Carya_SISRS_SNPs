...
1) *Carya* species samples ('Study Species'): Genome skim data for 8 species of diploid *Carya*  
...
2) *Carya* hybrid crosses ('Study Hybrids'): Genome skim data for crosses between diploid *Carya* species. There were 5 examples of crosses between pecan (*C. illinoinensis*) and one other diploid *Carya*:  
...
3) *Carya* companion samples ('Companion Species'): One set of independent, higher-depth sequencing runs for each of the 8 diploid *Carya* species.  
